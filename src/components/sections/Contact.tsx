    ...
    <section id="contact" className="border-t border-gray-100 scroll-mt-20" aria-labelledby="contact-heading">
      <div className="max-w-5xl mx-auto px-5 md:px-8 py-20 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          {/* Left — Info & CTA */}
          <div>
            <p className="text-sm font-semibold text-blue-600 mb-3">Contact</p>
            ...
            <p className="text-base text-gray-600 leading-relaxed mb-10 max-w-md">
              Whether you run a school, teach in one, or publish for one, we'd like to hear from you. Email us or use the form. Both reach the same inbox.
            </p>

            <div className="rounded-2xl border border-gray-200 bg-white divide-y divide-gray-100 shadow-sm">
              <a href="mailto:contact@operiumlabs.com" className="group flex items-start gap-5 p-5 hover:bg-blue-50/40 transition-colors first:rounded-t-2xl">
                <div className="w-11 h-11 rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0">
                  <Mail className="w-5 h-5 text-blue-600" />
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-gray-900 mb-0.5">Email</h4>
                  <span className="text-base text-gray-600 group-hover:text-blue-600 transition-colors">
              ...
              <div className="flex items-start gap-5 p-5 last:rounded-b-2xl">
                <div className="w-11 h-11 rounded-xl bg-indigo-50 flex items-center justify-center flex-shrink-0">
                  <MapPin className="w-5 h-5 text-indigo-600" />
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-gray-900 mb-0.5">Based in</h4>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-7">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 h-14 text-base font-semibold text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-70 rounded-xl transition-all shadow-md shadow-blue-600/20 mt-4"
              >
