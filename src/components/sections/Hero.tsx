...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-white via-operium-light/20 to-operium-light/40 pt-20 pb-24 md:pt-24 md:pb-32">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="animate-fade-in space-y-8">
            <div>
              <div className="inline-flex items-center rounded-full border border-operium-primary/20 bg-operium-light px-4 py-1 text-sm font-medium text-operium-primary mb-6">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-4 leading-tight">
                <span className="relative">
                  Transforming 
                  <span className="absolute -bottom-2 left-0 w-full h-3 bg-operium-secondary/20 -rotate-1"></span>
                </span>
            ...
            <div className="flex flex-wrap gap-5">
              <Button className="group bg-operium-primary hover:bg-operium-dark text-white px-6 py-6 rounded-xl shadow-lg shadow-operium-primary/20 transition-all hover:shadow-xl hover:shadow-operium-primary/30">
                Discover Our Ecosystem
                <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button variant="outline" className="border-operium-primary border-2 text-operium-primary hover:bg-operium-primary hover:text-white px-6 py-6 rounded-xl transition-all">
                Get in Touch
              </Button>
            </div>
            ...
            <div className="flex items-center space-x-4 pt-4 text-sm">
              <div className="flex -space-x-2">
                <img src="https://i.pravatar.cc/100?img=1" className="h-8 w-8 rounded-full border-2 border-white" />
                <img src="https://i.pravatar.cc/100?img=2" className="h-8 w-8 rounded-full border-2 border-white" />
                <img src="https://i.pravatar.cc/100?img=3" className="h-8 w-8 rounded-full border-2 border-white" />
              </div>
          ...
          <div className="hidden md:block relative animate-fade-in">
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -left-10 bg-white p-4 rounded-xl shadow-lg z-20 max-w-xs transform hover:-translate-y-1 transition-transform">
                <div className="flex items-center">
                  <div className="flex items-center justify-center h-10 w-10 rounded-full bg-operium-light text-operium-primary mr-3">
                    <ChevronRight className="h-5 w-5" />
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900">Mobile-First</h3>
                    <p className="text-sm text-gray-600">Accessible anywhere, anytime</p>
                  </div>
                </div>
              </div>
              
              <div className="absolute -top-8 right-10 bg-white p-4 rounded-xl shadow-lg z-20 max-w-xs transform hover:-translate-y-1 transition-transform">
                <div className="flex items-center">
                  <div className="flex items-center justify-center h-10 w-10 rounded-full bg-operium-light text-operium-primary mr-3">
                    <ChevronRight className="h-5 w-5" />
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900">Complete Solutions</h3>
                    <p className="text-sm text-gray-600">End-to-end integration</p>
                  </div>
                </div>
              </div>
            </div>
